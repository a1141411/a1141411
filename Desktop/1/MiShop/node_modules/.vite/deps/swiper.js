...
var Parallax = {
  ...
  setTranslate() {
    ...
    $el.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each((index2, el) => {
    ...
    slides.each((slideIndex, slideEl) => {
      ...
      $(slideEl).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each((index2, el) => {
  ...
  setTransition(duration = this.params.speed) {
    const swiper = this;
    const { $el } = swiper;
    $el.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each((index2, parallaxEl) => {
